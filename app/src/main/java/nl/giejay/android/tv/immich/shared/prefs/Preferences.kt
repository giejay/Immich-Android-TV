...
data object VIDEO_DISABLE_HARDWARE_DECODER : BooleanPref(false, ImmichApplication.appContext!!.getString(R.string.disable_hardware_decoder), ImmichApplication.appContext!!.getString(R.string.disable_hardware_decoder_desc))
...
data object ViewPrefScreen : PrefScreen(ImmichApplication.appContext!!.getString(R.string.view_settings), "view",
    listOf(
        ...
        PrefCategory(ImmichApplication.appContext!!.getString(R.string.slideshow), listOf(
            ...
            VIDEO_DISABLE_HARDWARE_DECODER,
