...
open class MediaSliderView(context: Context) : ConstraintLayout(context) {
    ...
    // internal
    protected lateinit var controller: MediaSliderController
    ...
    private fun initViewsAndSetAdapter(listener: ExoPlayerListener) {
        ...
        mPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(i: Int) {
                // Settled page only — onPageScrolled races animated Left/Right and left
                // timeline leave-off stuck on the asset that opened the slider.
    ...
    /** Subclasses use this for story chrome / date overlays after the pager settles. */
    protected open fun onPageSettled(index: Int) {}

    protected fun currentSliderItem(): SliderItemViewHolder = currentItem()
    protected fun currentSliderItemType(): SliderItemType = currentItemType()
